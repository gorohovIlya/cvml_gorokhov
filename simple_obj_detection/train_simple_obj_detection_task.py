...
class SimpleDetector(nn.Module):
    ...
    def forward(self, x):
        ...
        common = self.fc_common(features)
        cls_branch = F.dropout(common, p=0.5, training=self.training)
        return self.cls_head(cls_branch), torch.sigmoid(self.bbox_head(common))
...
root = Path("/home/ilyagorokhov/Python_Projects/AI/shapes_nn/shapes/shapes_dataset_random")
...
#TODO посмотреть высоту и ширину (зафиксировать одно из чисел)
#TODO разделить предсказание классов и bbox
#TODO не трогать слои